...
const Footer = () => {
    return (
        <footer className="footer items-center p-4 bg-gradient-to-r from-purple-700 to-purple-400 shadow-2xl fixed bottom-0 z-50 ">
            <div className="items-center grid-flow-col">
                ...
                <p className='text-white font-bold'>Copyright © 2022 - All right reserved</p>
            </div>
